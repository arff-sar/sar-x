...
ERROR_REGISTRY = {
    ...
    "SAR-X-AUTH-1302": ErrorSpec(
        error_code="SAR-X-AUTH-1302",
        title="Geçersiz E-posta Doğrulama Bağlantısı",
        user_message="E-posta doğrulama bağlantısı geçersiz veya süresi dolmuş.",
        owner_message="E-posta değişikliği için üretilen doğrulama tokenı doğrulanamadı.",
        module="AUTH",
        severity="warning",
        status_code=400,
        possible_cause="Token süresi doldu, kullanıldı, bozuldu veya kullanıcı bilgisiyle eşleşmedi.",
    ),
    "SAR-X-AUTH-1401": ErrorSpec(
        error_code="SAR-X-AUTH-1401",
        title="Geçersiz Bildirim Tercihi",
        user_message="Gönderilen bildirim tercihi bu hesap için geçersiz.",
        owner_message="Rol kapsamı dışında bir bildirim tercihi anahtarı gönderildi.",
        module="AUTH",
        severity="warning",
        status_code=400,
        possible_cause="Formda rol dışı preference anahtarı gönderildi veya istemci eski şema kullandı.",
    ),
