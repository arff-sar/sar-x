...
def upgrade():
    if not _has_table("assignment_record"):
        op.create_table(
            "assignment_record",
    ...
    _create_index_if_missing("assignment_record", "ix_assignment_record_airport_id", ["airport_id"], unique=False)
    _create_index_if_missing("assignment_record", "ix_assignment_record_assignment_date", ["assignment_date"], unique=False)
    _create_index_if_missing("assignment_record", "ix_assignment_record_assignment_no", ["assignment_no"], unique=True)
    _create_index_if_missing("assignment_record", "ix_assignment_record_created_by_id", ["created_by_id"], unique=False)
    _create_index_if_missing("assignment_record", "ix_assignment_record_delivered_by_id", ["delivered_by_id"], unique=False)
    _create_index_if_missing("assignment_record", "ix_assignment_record_is_deleted", ["is_deleted"], unique=False)
    _create_index_if_missing("assignment_record", "ix_assignment_record_status", ["status"], unique=False)

    if not _has_table("assignment_recipient"):
        op.create_table(
    ...
    _create_index_if_missing("assignment_recipient", "ix_assignment_recipient_assignment_id", ["assignment_id"], unique=False)
    _create_index_if_missing("assignment_recipient", "ix_assignment_recipient_is_deleted", ["is_deleted"], unique=False)
    _create_index_if_missing("assignment_recipient", "ix_assignment_recipient_user_id", ["user_id"], unique=False)

    if not _has_table("assignment_item"):
        op.create_table(
            "assignment_item",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("assignment_id", sa.Integer(), nullable=False),
    ...
    _create_index_if_missing("assignment_item", "ix_assignment_item_asset_id", ["asset_id"], unique=False)
    _create_index_if_missing("assignment_item", "ix_assignment_item_assignment_id", ["assignment_id"], unique=False)
    _create_index_if_missing("assignment_item", "ix_assignment_item_is_deleted", ["is_deleted"], unique=False)
    _create_index_if_missing("assignment_item", "ix_assignment_item_material_id", ["material_id"], unique=False)
    _create_index_if_missing("assignment_item", "ix_assignment_item_returned_by_id", ["returned_by_id"], unique=False)

    if not _has_table("assignment_history_entry"):
        op.create_table(
    ...
    _create_index_if_missing("assignment_history_entry", "ix_assignment_history_entry_assignment_id", ["assignment_id"], unique=False)
    _create_index_if_missing("assignment_history_entry", "ix_assignment_history_entry_created_by_id", ["created_by_id"], unique=False)
    _create_index_if_missing("assignment_history_entry", "ix_assignment_history_entry_event_type", ["event_type"], unique=False)

    if not _has_table("maintenance_instruction"):
        op.create_table(
    ...
    _create_index_if_missing("maintenance_instruction", "ix_maintenance_instruction_equipment_template_id", ["equipment_template_id"], unique=True)
    _create_index_if_missing("maintenance_instruction", "ix_maintenance_instruction_is_active", ["is_active"], unique=False)
    _create_index_if_missing("maintenance_instruction", "ix_maintenance_instruction_is_deleted", ["is_deleted"], unique=False)

    if not _has_table("ppe_record"):
        op.create_table(
            "ppe_record",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("user_id", sa.Integer(), nullable=False),
    ...
    _create_index_if_missing("ppe_record", "ix_ppe_record_airport_id", ["airport_id"], unique=False)
    _create_index_if_missing("ppe_record", "ix_ppe_record_assignment_id", ["assignment_id"], unique=False)
    _create_index_if_missing("ppe_record", "ix_ppe_record_created_by_id", ["created_by_id"], unique=False)
    _create_index_if_missing("ppe_record", "ix_ppe_record_delivered_at", ["delivered_at"], unique=False)
    _create_index_if_missing("ppe_record", "ix_ppe_record_is_deleted", ["is_deleted"], unique=False)
    _create_index_if_missing("ppe_record", "ix_ppe_record_status", ["status"], unique=False)
    _create_index_if_missing("ppe_record", "ix_ppe_record_user_id", ["user_id"], unique=False)

    if not _has_table("ppe_record_event"):
        op.create_table(
            "ppe_record_event",
            sa.Column("id", sa.Integer(), nullable=False),
    ...
    _create_index_if_missing("ppe_record_event", "ix_ppe_record_event_created_by_id", ["created_by_id"], unique=False)
    _create_index_if_missing("ppe_record_event", "ix_ppe_record_event_event_type", ["event_type"], unique=False)
    _create_index_if_missing("ppe_record_event", "ix_ppe_record_event_ppe_record_id", ["ppe_record_id"], unique=False)
    _create_index_if_missing("ppe_record_event", "ix_ppe_record_event_status_after", ["status_after"], unique=False)
