...
class BaseConfig:
    ...
    MESSAGE_READ_RATE_LIMIT = os.getenv("MESSAGE_READ_RATE_LIMIT", "30 per minute")
    PUBLIC_HOMEPAGE_BROWSER_CACHE_SECONDS = int(os.getenv("PUBLIC_HOMEPAGE_BROWSER_CACHE_SECONDS", "90"))
